...
import { MdOutlineMenu, MdClose, MdHome, MdSmartphone, MdLaptop } from 'react-icons/md';
...
const Sidebar = () => {
  ...
  const menuItems: MenuItem[] = [
    { id: 1, name: 'Home', icon: <MdHome className="w-5 h-5" />, active: true },
    ...
    { id: 6, name: 'Home Products', icon: <SiHomeassistant className="w-5 h-5" />, active: false },
  ];
